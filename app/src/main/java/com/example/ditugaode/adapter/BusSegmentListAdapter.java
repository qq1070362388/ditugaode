...
import com.example.ditugaode.busresult.SchemeBusStep;
...
public class BusSegmentListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (position == 0) {
            holder.busDirIcon.setImageResource(R.drawable.qi);
            ...
            holder.busDirIcon.setImageResource(R.drawable.end);
